...
├── 4. analyze_duplicates      # Анализ дублей
├── 5. test_docker_integration.bat
├── 6. check_server_data.py    # Проверка данных
├── 7. local_data_manager.py   # Управление файлами
├── 8. upload_existing_to_docker.bat
├── 9. upload_from_old_parser.bat  # 🚀 НОВЫЙ: загрузка из старого парсера
└── 10. setup_python.bat       # Настройка Python
```
...
- **Данные на серверах**: через главное меню → пункт 6
...
main_menu.bat       # Пункт 10 - настройка Python
```
